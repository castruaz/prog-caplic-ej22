# Muestra estadisticas de un conjunto de datos de jugadores de la Fifa
# Los datos de cada jugador: id, nombre, valor en euros, edad, peso, nacionalidad 

from p116modulofifa import *
...
imprime(fifa,'nombre',False)
print('\nPor valor en euros del mayor a menor')
imprime(fifa,'valeuros',True)

# mayor y menor segun valor en euros
may = valor_mayor(fifa,'valeuros')
men = valor_menor(fifa,'valeuros')
valor_mayor(fifa,'valeuros')
...
may = valor_mayor(fifa,'edad')
men = valor_menor(fifa,'edad')
valor_mayor(fifa,'valeuros')
